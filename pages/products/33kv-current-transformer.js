...
export default function CurrentTransformer33kV() {
  ...
  return (
    <div className="min-h-screen">
      <NextSeo
        title="33kV Current Transformer - Vamet Industries"
        description="High-quality 33kV Current Transformer for outdoor applications. Oil-filled, vacuum impregnated with Class 0.2S accuracy for metering applications."
        canonical="https://vametindustries.com/products/33kv-current-transformer"
      />
      <Head>
        <title>33kV Current Transformer - Vamet Industries</title>
        <link
          rel="icon"
          type="image/jpeg"
            ...
            <div className="lg:sticky lg:top-8">
              <div className="bg-white rounded-lg shadow-lg p-6 border border-gray-200">
                <div className="relative h-[500px] mb-4">
                  <Image
                    src="/images/site/vamet-product-details-4.jpg"
                    alt="33kV Current Transformer"
                    layout="fill"
                    objectFit="contain"

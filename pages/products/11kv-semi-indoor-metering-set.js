...
export default function SemiIndoorMeteringSet11kV() {
  ...
  return (
    <div className="min-h-screen">
      <NextSeo
        title="11 kV Semi-Indoor Metering Set - Vamet Industries"
        description="High-quality 11 kV Semi-Indoor Metering Set designed for outdoor applications. Oil-filled, vacuum impregnated for metering applications."
        canonical="https://vametindustries.com/products/11kv-semi-indoor-metering-set"
      />
      <Head>
        <title>11 kV Semi-Indoor Metering Set - Vamet Industries</title>
        <link
          rel="icon"
          type="image/jpeg"
        ...
        <div className="max-w-7xl px-4 mx-auto sm:px-6 lg:px-8">
          ...
          <div className="mb-8">
            ...
            <p className="text-lg text-gray-600">
              High-quality outdoor semi-indoor metering set designed for
              metering applications combining voltage and current transformers
            </p>
          </div>
            ...
            <div className="lg:sticky lg:top-8">
              <div className="bg-white rounded-lg shadow-lg p-6 border border-gray-200">
                <div className="relative h-[500px] mb-4">
                  <Image
                    src="/images/site/vamet-product-details-9.jpg"
                    alt="11 kV Semi-Indoor Metering Set"
                    layout="fill"
                    objectFit="contain"
                ...
                <p className="text-sm text-gray-600 text-center">
                  Outdoor Oil-Filled Semi-Indoor Metering Set for Metering
                  Applications
                </p>
              </div>

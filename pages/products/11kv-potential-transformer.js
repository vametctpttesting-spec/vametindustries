...
export default function PotentialTransformer11kV() {
  ...
  return (
    <div className="min-h-screen">
      <NextSeo
        title="11kV Single Phase Potential Transformer - Vamet Industries"
        description="High-quality 11kV Single Phase Potential Transformer for outdoor applications. Oil-filled, vacuum impregnated for metering and protection applications."
        canonical="https://vametindustries.com/products/11kv-potential-transformer"
      />
      <Head>
        <title>
          11kV Single Phase Potential Transformer - Vamet Industries
        </title>
        <link
          rel="icon"
          type="image/jpeg"
                ...
                <div className="overflow-x-auto">
                  <table className="w-full text-sm">
                    <tbody>
                      ...
                      <tr className="border-b border-gray-100">
                        ...
                        <td className="py-2 text-gray-600">
                          <div className="space-y-1">
                            <div>a. Rated system voltage: 11kV</div>
                            <div>b. Highest system voltage: 12 kV</div>
                      ...
                      <tr>
                        <td className="py-2 font-medium text-gray-700">
                          20. Outline dimensional drawing with mounting details
                        </td>
                        <td className="py-2 text-gray-600">
                          As per our drawing
                        </td>
            ...
            <div className="lg:sticky lg:top-8">
              <div className="bg-white rounded-lg shadow-lg p-6 border border-gray-200">
                <div className="relative h-[500px] mb-4">
                  <Image
                    src="/images/site/vamet-product-details-2.jpg"
                    alt="11kV Single Phase Potential Transformer"
                    layout="fill"
                    objectFit="contain"

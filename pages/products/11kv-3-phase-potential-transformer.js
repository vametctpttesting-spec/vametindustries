...
export default function PotentialTransformer11kV3Phase() {
  ...
  return (
    <div className="min-h-screen">
      <NextSeo
        title="11kV 3 Phase Potential Transformer - Vamet Industries"
        description="High-quality 11kV 3 Phase Potential Transformer designed for outdoor applications. Oil-filled, vacuum impregnated for metering and protection applications."
        canonical="https://vametindustries.com/products/11kv-3-phase-potential-transformer"
      />
      <Head>
        <title>11kV 3 Phase Potential Transformer - Vamet Industries</title>
        <link
          rel="icon"
          type="image/jpeg"
        ...
        <div className="max-w-7xl px-4 mx-auto sm:px-6 lg:px-8">
          ...
          <div className="mb-8">
            ...
            <p className="text-lg text-gray-600">
              High-quality outdoor 3-phase potential transformer designed for
                  ...
                  <table className="w-full text-sm">
                    <tbody className="space-y-2">
                      ...
                      <tr className="border-b border-gray-100">
                        ...
                        <td className="py-2 text-gray-600">Three</td>
                      </tr>
                      <tr className="border-b border-gray-100">
                        <td className="py-2 font-medium text-gray-700">
                          No of windings per phase
                        </td>
                        <td className="py-2 text-gray-600">Two</td>
                      </tr>
                      <tr className="border-b border-gray-100">
                        <td className="py-2 font-medium text-gray-700">
                          Winding Connections
              ...
              <div className="bg-white rounded-lg shadow-lg p-6 border border-gray-200">
                  ...
                  <table className="w-full text-sm">
                    <tbody>
                      ...
                      <tr className="border-b border-gray-100">
                        ...
                        <td className="py-2 text-gray-600">
                          Outdoor, Oil filled, Vacuum Impregnated;VOD
                        </td>
                      </tr>
                      <tr className="border-b border-gray-100">
                        <td className="py-2 font-medium text-gray-700">
                      ...
                      <tr className="border-b border-gray-100">
                        ...
                        <td className="py-2 text-gray-600">
                          <div className="space-y-1">
                            ...
                            <div>
                              <strong>d.</strong> Nature of neutral earthing:
                              Effective
                            </div>
                          </div>
                        </td>
                      ...
                      <tr className="border-b border-gray-100">
                        <td className="py-2 font-medium text-gray-700">
                          10. Type of transformer
                        </td>
                        <td className="py-2 text-gray-600">Earthed</td>
                      </tr>
                      <tr className="border-b border-gray-100">
                        <td className="py-2 font-medium text-gray-700">
                          11. Rated Burden per phase
                        </td>
                        <td className="py-2 text-gray-600">
                          As per requirement
                        </td>
                      ...
                      <tr className="border-b border-gray-100">
                        <td className="py-2 font-medium text-gray-700">
                          14. Rated voltage factor and time
                        </td>
                        <td className="py-2 text-gray-600">1.2 continuous *</td>
                      </tr>
                      <tr className="border-b border-gray-100">
                        <td className="py-2 font-medium text-gray-700">
                          15. Limits of ratio and phase error
                        </td>
                        <td className="py-2 text-gray-600">
                      ...
                      <tr className="border-b border-gray-100">
                        <td className="py-2 font-medium text-gray-700">
                          16. Temperature rise of top oil at 1.1 times rated
                      ...
                      <tr className="border-b border-gray-100">
                        <td className="py-2 font-medium text-gray-700">
                          17. H.V. Insulation characteristic of porcelain
                          bushing
                        </td>
                        <td className="py-2 text-gray-600">
                          <div className="space-y-1">
                            <div>
                              <strong>a.</strong> Type: Outdoor, Glazed
                              Porcelain to IS 2099. *
                            </div>
                            <div>
                            ...
                            <div>
                              <strong>d.</strong> Total creepage distance: 192
                              mm minimum. *
                            </div>
                          </div>
                        </td>
                      ...
                      <tr className="border-b border-gray-100">
                        <td className="py-2 font-medium text-gray-700">
                          18. One-minute power frequency withstand test on
                          primary winding
                        </td>
                      ...
                      <tr className="border-b border-gray-100">
                        <td className="py-2 font-medium text-gray-700">
                          19. One-minute power frequency withstand test on
                          secondary winding
                        </td>
                      ...
                      <tr className="border-b border-gray-100">
                        <td className="py-2 font-medium text-gray-700">
                          20. High voltage impulse withstand test on primary
                          Windings
                        </td>
                      ...
                      <tr className="border-b border-gray-100">
                        <td className="py-2 font-medium text-gray-700">
                          21. One-minute power frequency withstand test on
                          secondary winding : Oil
                        </td>
                        <td className="py-2 text-gray-600">
                          <div className="space-y-1">
                            <div>
                      ...
                      <tr className="border-b border-gray-100">
                        <td className="py-2 font-medium text-gray-700">
                          22. Total weight of P.T. with oil
                        </td>
                      ...
                      <tr>
                        <td className="py-2 font-medium text-gray-700">
                          24. Outline dimensional drawing with mounting details
                        </td>
                ...
                <div className="mt-4 p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
                  <p className="text-sm text-yellow-800">
                    ...
                    The potential transformers shall carry 50% above the rated
                    burden continuously without injury but the accuracies will
                    not be maintained at these higher burdens.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="lg:sticky lg:top-8">
              <div className="bg-white rounded-lg shadow-lg p-6 border border-gray-200">
                <div className="relative h-[500px] mb-4">
                  <Image
                    src="/images/site/vamet-product-details-8.jpg"
                    alt="11kV 3 Phase Potential Transformer"
                    layout="fill"
                    objectFit="contain"
                ...
                <p className="text-sm text-gray-600 text-center">
                  Outdoor Oil-Filled 3-Phase Potential Transformer for Metering

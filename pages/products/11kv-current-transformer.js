...
export default function CurrentTransformer11kV() {
  ...
  return (
    <div className="min-h-screen">
      <NextSeo
        title="11kV Current Transformer - Vamet Industries"
        description="High-quality 11kV Current Transformer for outdoor applications. Oil-filled, vacuum impregnated with Class 0.2S accuracy for metering applications."
        canonical="https://vametindustries.com/products/11kv-current-transformer"
      />
      <Head>
        <title>11kV Current Transformer - Vamet Industries</title>
        <link
          rel="icon"
          type="image/jpeg"
        ...
        <div className="max-w-7xl px-4 mx-auto sm:px-6 lg:px-8">
          ...
          <div className="mb-8">
            ...
            <p className="text-lg text-gray-600">
              High-quality outdoor current transformer for metering applications
            </p>
          </div>
              ...
              <div className="bg-white rounded-lg shadow-lg p-6 border border-gray-200">
                  ...
                  <table className="w-full text-sm">
                    <tbody>
                      ...
                      <tr className="border-b border-gray-100">
                        ...
                        <td className="py-2 text-gray-600">COD</td>
                      </tr>
                      <tr className="border-b border-gray-100">
                        <td className="py-2 font-medium text-gray-700">
                      ...
                      <tr className="border-b border-gray-100">
                        ...
                        <td className="py-2 text-gray-600">As per spec Amps</td>
                      </tr>
                      <tr className="border-b border-gray-100">
                        <td className="py-2 font-medium text-gray-700">
                          Number of Secondary Cores
                        </td>
                        <td className="py-2 text-gray-600">One</td>
                      </tr>
                      <tr className="border-b border-gray-100">
                        <td className="py-2 font-medium text-gray-700">
                          Rated Secondary Current
                        </td>
                        <td className="py-2 text-gray-600">1 or 5 Amp</td>
                      </tr>
                      <tr className="border-b border-gray-100">
                        <td className="py-2 font-medium text-gray-700">
                          Rated Output
                      ...
                      <tr className="border-b border-gray-100">
                        <td className="py-2 font-medium text-gray-700">
                          Short time thermal current & duration
                        </td>
                        <td className="py-2 text-gray-600">As per spec kA</td>
                      </tr>
                      <tr className="border-b border-gray-100">
                        <td className="py-2 font-medium text-gray-700">
                      ...
                      <tr className="border-b border-gray-100">
                        <td className="py-2 font-medium text-gray-700">
                          One-minute power frequency dry/wet withstand test
                          voltage on primary
                        </td>
                      ...
                      <tr className="border-b border-gray-100">
                        <td className="py-2 font-medium text-gray-700">
                          One-minute power frequency withstand test voltage on
                          secondary
                        </td>
                      ...
                      <tr className="border-b border-gray-100">
                        <td className="py-2 font-medium text-gray-700">
                          Whether CT is hermetically sealed
                        </td>
                      ...
                      <tr className="border-b border-gray-100">
                        <td className="py-2 font-medium text-gray-700">
                          Equipment conforms to specification
                        </td>
                        <td className="py-2 text-gray-600">IS 2705</td>
                      </tr>
                      <tr>
                ...
                <div className="mt-4 p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
                  <p className="text-sm text-yellow-800">
                    <strong>Note:</strong> Items marked with* are guaranteed.
                    All others are indicative and subject to change.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="lg:sticky lg:top-8">
              <div className="bg-white rounded-lg shadow-lg p-6 border border-gray-200">
                <div className="relative h-[500px] mb-4">
                  <Image
                    src="/images/site/vamet-product-details-1.jpg"
                    alt="11kV Current Transformer"
                    layout="fill"
                    objectFit="contain"
                ...
                <p className="text-sm text-gray-600 text-center">
                  Outdoor Oil-Filled Current Transformer for Metering
                  Applications
                </p>
              </div>
